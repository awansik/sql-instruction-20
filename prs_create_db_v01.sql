...
insert into user (ID, UserName, Password, FirstName, LastName, PhoneNumber, Email, IsReviewer, IsAdmin) VALUES
	...
	(2, 'awansik', 'login', 'Andrew', 'Wansik', '513-833-6682', 'amwansik@gmail.com', 1, 1),
    (3, 'stonecold', 'hellyeah', 'Steve', 'Austin', '123-456-7890', 'stonecoldsteveaustin@gmail.com', 1, 0),
    (4, 'thedudeman', 'rug', 'Jeff', 'Bridges', '987-654-3210', 'thedudeman@gmail.com', 0, 0);
